...
RELEASE_COMMANDS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            "-m",
            "pytest",
            "tests/research_agent/core/test_resource_scheduler.py",
            "tests/research_agent/core/test_bounded_context.py",
            "tests/research_agent/core/test_permissioned_memory_store.py",
            "tests/research_agent/core/test_capability_requests.py",
            "tests/research_agent/execution/test_coder_resource_wiring.py",
            "tests/research_agent/core/test_reviewed_memory_wiring.py",
            "tests/research_agent/integration/test_capability_workflow_wiring.py",
            "tests/research_agent/integration/test_workflow.py",
            "tests/research_agent/core/test_char_golden_run_bundle.py",
            "tests/research_agent/authority/test_typed_input_consumption_receipt.py",
            "tests/research_agent/core/test_typed_input_sdk.py",
            "tests/research_agent/core/test_experience_bank.py::test_permissioned_quarantine_mirror_failure_is_nonfatal_to_completed_run",
            "-q",
        ),
    ),
)
