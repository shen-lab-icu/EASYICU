...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--out", default=None, help="output JSON path (default: tempfile.mkdtemp/mined_ideas_completed.json)")
...
def main() -> None:
    ...
    if args.out:
        ...
        out_path = Path(tempfile.mkdtemp(prefix="easyicu_mined_ideas_")) / "mined_ideas_completed.json"
    ...
    n = int(cohort.shape[0])
    d = int(cohort.hospital_expire_flag.sum())
