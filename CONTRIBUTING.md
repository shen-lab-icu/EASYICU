...
6. Complete the repository pull request template, including the exact focused
   test commands, evidence class, claim ceiling, and deliberately excluded scope.
7. For a release candidate, complete [`docs/release_checklist.md`](docs/release_checklist.md)
