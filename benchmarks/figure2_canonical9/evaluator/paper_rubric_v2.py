...
The previously frozen ``figure2_rubric`` v1 remains byte-compatible.  This v2
contract is additive: it introduces the paper-only exact-five payload, a full
research-agent source-tree coordinate, and a frozen evaluator protocol without
rewriting the historical v1 decoder or manifest bytes.
"""
