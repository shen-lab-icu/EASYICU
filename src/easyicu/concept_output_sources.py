...
COMPOSITE_CONCEPT_OUTPUT_SOURCES: dict[str, str] = {
    ...
    "aki_severe": "kdigo_aki",
    "aki_severe_creat": "kdigo_aki",
    "aki_severe_uo": "kdigo_aki",
    "aki_severe_rrt": "kdigo_aki",
    "aki_severe_assessable": "kdigo_aki",
    "aki_severe_ascertainment": "kdigo_aki",
    ...
    "creatinine_ascertainment_reason": "kdigo_aki",
