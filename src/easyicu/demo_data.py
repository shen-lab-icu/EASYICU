...
def save_demo_data(output_dir: str, num_patients: int = 100) -> Dict[str, str]:
    ...
    metadata = {
        ...
        'files': saved_files,
        'description': 'EasyICU Demo Dataset - Synthetic ICU data for demonstration purposes',
    }
...
def is_demo_mode() -> bool:
    """检查是否处于演示模式"""
    import os
    return os.environ.get('EASYICU_DEMO_MODE', '').lower() in ('1', 'true', 'yes')
