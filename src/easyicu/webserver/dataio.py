...
# Historical alias for the coded export-contract error now owned by the
# concept layer (never caught by type; identity preserved for callers/tests).
ExportCohortError = TypedExportError
