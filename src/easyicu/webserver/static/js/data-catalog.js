...
(function () {
  ...
  const groupConcepts = {
    ...
    renal: ["urine", "urine24", "uo_6h", "uo_12h", "uo_24h", "rrt", "rrt_criteria", "aki_reference", "aki_stage_reference", "aki_severe_reference", "aki_stage_creat_reference", "aki_stage_uo_reference", "aki_stage_rrt_reference", "aki_stage_reference_smoothed_6h", "aki_reference_profile", "aki_reference_status", "aki_reference_authority", "aki_reference_reliability_grade", "aki_reference_fidelity", "aki_reference_rrt_scope", "aki_reference_uses_future", "aki_source_native", "aki_stage_source_native", "aki_severe_source_native", "aki_stage_creat_source_native", "aki_stage_uo_source_native", "aki_stage_crrt_source_native", "aki_stage_source_native_smoothed", "aki_source_native_profile", "aki_source_native_status", "aki_source_native_authority", "aki_source_native_reliability_grade", "aki_source_native_fidelity", "aki_source_native_ascertainment", "aki_source_native_reason", "aki_source_native_time_scale", "aki_source_native_uses_future", "kidney_observation_window_coverage", "creatinine_evidence_status", "creatinine_evidence_reason", "urine_evidence_status", "rrt_evidence_status", "rrt_evidence_reason", "creat_low_past_48hr", "creat_low_past_7day", "creat_baseline_n_48h", "creat_baseline_n_7d", "creat_baseline_source", "creat_pre_icu_history_observed", "uo_rt_6hr", "uo_rt_12hr", "uo_rt_24hr", "fluid_balance", "fluid_balance_cumulative", "total_input_ml", "bun_creatinine_ratio", "egfr"],
