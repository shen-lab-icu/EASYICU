...
Collection of general-purpose utility functions used throughout easyicu,
...
def ensure_list(x: Any) -> List:
    """Ensure value is a list (easyicu utility).
...
def flatten_list(x: List[Any]) -> List[Any]:
    """Flatten nested list one level (easyicu utility).
