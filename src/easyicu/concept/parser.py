...
def apply_binary_op(symbol: str, series: pd.Series, value: object) -> pd.Series:
    ...
    from ..utils.callback_utils import fahr_to_cels
    from ..utils.unit_conversion import celsius_to_fahrenheit, fahrenheit_to_celsius
    ...
    if symbol == "/":
        from ..utils.callback_utils import binary_op
