"""
Feature module configuration for easyicu.

This module defines the mapping between ricu CSV exports and easyicu concepts.
Used by verification scripts to compare easyicu output with ricu reference data.
...
@dataclass
class FeatureModule:
    """Metadata describing a ricu CSV <-> easyicu concept family."""
