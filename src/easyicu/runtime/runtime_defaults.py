...
Expose helper utilities so scripts/tests can stay concise while easyicu
...
_DEFAULT_ENV_KEYS: Dict[str, Sequence[str]] = {
    "chunk": ("EASYICU_CHUNK_SIZE",),
    "parallel": ("EASYICU_PARALLEL_WORKERS",),
    "concept": ("EASYICU_CONCEPT_WORKERS",),
    "backend": ("EASYICU_PARALLEL_BACKEND",),
}
