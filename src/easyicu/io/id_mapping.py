...
from ..utils.assertions import assert_that, is_string
...
def id_map(
    ...
    try:
        from ..utils.assertions import assert_that, is_string, is_flag
    except ImportError:
...
def id_orig_helper(
    ...
    """
    from .data_env import get_src_env, as_src_env
    from .table.convert import as_id_cfg
...
def as_src_env(x: Any) -> Any:
    ...
    from .table.convert import as_src_cfg
    try:
        config = as_src_cfg(x)
        from ..datasource import ICUDataSource
