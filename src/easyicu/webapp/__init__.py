...
def run_app(
    ...
    cmd = [
        ...
        '--server.enableCORS', 'false',  # 允许 VS Code Remote-SSH 端口转发
        '--server.enableXsrfProtection', 'false',  # 允许代理 WebSocket 连接
    ...
    # 后台运行
    if background:
        log_file = open('/tmp/easyicu_webapp.log', 'a')
        ...
        print("   日志文件: /tmp/easyicu_webapp.log")
        return
