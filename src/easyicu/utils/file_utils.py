...
def data_dir(subdir: Optional[str] = None, create: bool = True) -> str:
    ...
    - Linux: ~/.local/share/easyicu
    - macOS: ~/Library/Application Support/easyicu
    - Windows: %LOCALAPPDATA%/easyicu
    
    The environment variable EASYICU_DATA_PATH can be used to overwrite the
    default location.
    ...
    Examples:
        >>> data_dir()
        '/home/user/.local/share/easyicu'
        >>> data_dir('mimic')
        '/home/user/.local/share/easyicu/mimic'
    """
    res = sys_env("EASYICU_DATA_PATH", unset="")
...
def user_config_path() -> Optional[List[str]]:
    ...
    """
    res = sys_env("EASYICU_CONFIG_PATH", unset="")
...
def auto_attach_srcs() -> List[str]:
    ...
    """
    res = sys_env("EASYICU_SRC_LOAD", unset="")
...
def file_exists(path: str) -> bool:
    """Check if file exists (easyicu utility).
...
def get_file_size(path: str) -> int:
    """Get file size in bytes (easyicu utility).
...
def list_files(directory: str, pattern: Optional[str] = None, 
    ...
    """List files in directory (easyicu utility).
