...
def msg_easyicu(msg: str, type: str = "info", indent: int = 0, exdent: int = 0):
    """Print formatted message (R ricu msg_easyicu).
...
def warn_easyicu(msg: str, **kwargs):
    """Print warning message (R ricu warn_easyicu).
    
    Args:
        msg: Warning message
        **kwargs: Additional arguments for msg_easyicu
    """
    msg_easyicu(msg, type="warning", **kwargs)

def stop_easyicu(msg: str, **kwargs):
    """Print error message and raise exception (R ricu stop_easyicu).
    ...
    Raises:
        RuntimeError
    """
    msg_easyicu(msg, type="error", **kwargs)
...
def msg_progress(msg: str):
    ...
    Args:
        msg: Message to print
    """
    msg_easyicu(msg, type="progress_body", indent=2, exdent=4)
