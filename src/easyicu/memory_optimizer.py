"""
Memory optimization utilities for easyicu - 16GB RAM optimization.
...
def optimize_for_16gb():
    """Configure easyicu for optimal performance on 16GB systems."""
...
_config = None
if os.getenv('EASYICU_AUTO_OPTIMIZE_16GB', 'false').lower() in ('true', '1', 'yes'):
    try:
