...
E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04 = replace(
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_03,
    version="20260904",
    locked_at="2026-09-04T04:37:27-04:00",
    # Additive re-lock after the current concept dictionary incorporated the
    # audited data/concept-owner changes merged from main. Keep 20260903
    # immutable so runs bound to that dictionary remain reproducible.
    expected_concept_dict_sha=(
        "fd122adc01693d78e760e19e61cb415ce8aef849ff2712f747dd79c289d48313"
    ),
)

E1_REVIEWED_DEMO_2026_09_04 = replace(
    E1_REVIEWED_DEMO_2026_09_03,
    version="20260904",
    locked_at=E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04.locked_at,
    expected_concept_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04.expected_concept_dict_sha
    ),
)

E1_PROGRESSIVE_PLANNER_CANARY_2026_09_05 = replace(
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04,
    version="20260905",
    locked_at="2026-09-05T03:51:51Z",
    # The extraction branch clarified the SOFA-2 primary missing-domain
    # contract in the packaged dictionary. Add a new development coordinate;
    # do not rewrite the frozen 20260904 replay profile or a data release.
    expected_sofa2_dict_sha=(
        "b804b56fe4522b067b6ee499b616371e026d1452bc20f8f378c694217ef2f476"
    ),
)

E1_REVIEWED_DEMO_2026_09_05 = replace(
    E1_REVIEWED_DEMO_2026_09_04,
    version="20260905",
    locked_at=E1_PROGRESSIVE_PLANNER_CANARY_2026_09_05.locked_at,
    expected_sofa2_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_05.expected_sofa2_dict_sha
    ),
)
...
E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18 = replace(
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_17,
    version="20260918",
    locked_at="2026-09-18T00:00:00+08:00",
    # v6 dict/formula round: po2 min 40->20 (ee33539 clinically reviewed 20;
    # v5 min exactly 40.0 all DBs proves true hypoxia discarded), adh_rate
    # 0-0.15 / phn_rate 0-15 (ee33539; v5 tails adh 190/phn 475 prove unit
    # errors), norepi_equiv median->sum (additive potency; SOFA cardio uses
    # norepi60 etc, unaffected). The 20260917 coordinate stays byte-frozen
    # for historical replay.
    expected_concept_dict_sha=(
        "ebce6b4e8cfadbbc2a6a6c8e923e64709012a0f14aa4e3284430fa796343edbf"
    ),
)

E1_REVIEWED_DEMO_2026_09_18 = replace(
    E1_REVIEWED_DEMO_2026_09_17,
    version="20260918",
    locked_at=E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18.locked_at,
    expected_concept_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18.expected_concept_dict_sha
    ),
)

E1_PROGRESSIVE_PLANNER_CANARY_2026_09_21 = replace(
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18,
    version="20260921",
    locked_at="2026-09-21T00:00:00+08:00",
    # Bind the finalized v6 foundation resources after the clean six-database
    # rebuild.  Earlier development coordinates remain immutable replay
    # contracts for their original dictionary bytes.
    expected_concept_dict_sha=(
        "ab4edb8a79388ccbd902001ad6b733d063042a423d7b6507ad0dd3dd3b04b720"
    ),
    expected_sofa2_dict_sha=(
        "c53b7d1c5eda51c9e88727e75eebbd93f579d0a297a5fa6f49b646032dc4faa3"
    ),
)

E1_REVIEWED_DEMO_2026_09_21 = replace(
    E1_REVIEWED_DEMO_2026_09_18,
    version="20260921",
    locked_at=E1_PROGRESSIVE_PLANNER_CANARY_2026_09_21.locked_at,
    expected_concept_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_21.expected_concept_dict_sha
    ),
    expected_sofa2_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_21.expected_sofa2_dict_sha
    ),
)
...
E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_04 = replace(
...
E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_04 = replace(
...
E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_05 = replace(
...
E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_05 = replace(
...
E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_18 = replace(
    E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_17,
    version="20260918",
    locked_at=E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18.locked_at,
    # Same v6 re-lock as the 20260918 canary pair; the 20260917
    # live-pubmed coordinate stays byte-frozen for historical replay.
    expected_concept_dict_sha=(
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18.expected_concept_dict_sha
    ),
...
E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_18 = replace(
...
E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_21 = replace(
...
E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_21 = replace(
    E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_18,
    version="20260921",
    locked_at=E1_REVIEWED_DEMO_2026_09_21.locked_at,
    expected_concept_dict_sha=(
        E1_REVIEWED_DEMO_2026_09_21.expected_concept_dict_sha
    ),
    expected_sofa2_dict_sha=(
        E1_REVIEWED_DEMO_2026_09_21.expected_sofa2_dict_sha
    ),
)
...
SUBMISSION_PROFILE_REGISTRY: Dict[str, SubmissionProfile] = {
    ...
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04.ref: (
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_04
    ),
    ...
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18.ref: (
        E1_PROGRESSIVE_PLANNER_CANARY_2026_09_18
    ),
    E1_PROGRESSIVE_PLANNER_CANARY_2026_09_21.ref: (
    ...
    E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_18.ref: (
        E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_18
    ),
    E1_PROGRESSIVE_PLANNER_CANARY_LIVE_PUBMED_2026_09_21.ref: (
    ...
    E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_18.ref: (
        E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_18
    ),
    E1_REVIEWED_DEMO_LIVE_PUBMED_2026_09_21.ref: (
