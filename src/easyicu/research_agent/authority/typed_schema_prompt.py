"""Bounded Coder rendering of host-verified typed table facts.

The binding authority remains machine-readable.  This leaf module renders only
the bounded schema, row-count, and Planner-owned consumption facts needed by a
Coder; it performs no evidence selection or scientific role assignment.
"""
...
from ..contracts.typed_schema import typed_product_prompt_facts
