...
from .figures.association_prior_outputs import _render_association_publication_bundle_from_prior_outputs
from .figures.sensitivity_prior_outputs import _render_sensitivity_publication_bundle_from_prior_outputs
from .figures.prior_output_contracts import (
    _planned_primary_association_contract, _resolve_upstream_analysis_method,
)
...
# provider, which the registry re-reads on each resolution. Their implementations
# now all live in figure/reporting owners. These re-exports preserve callers
# that looked them up in these globals at call time — so a caller
