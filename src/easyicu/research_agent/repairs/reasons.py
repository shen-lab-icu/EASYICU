...
class RepairReason(str, Enum):
    ...
    INVALID_CONTAINER_ACCESS = "INVALID_CONTAINER_ACCESS"
    FIGURE_OUTPUT_REGISTRATION_INVALID = "FIGURE_OUTPUT_REGISTRATION_INVALID"
...
_DETAIL_REASON_CODES = {
    ...
    "literal_mapping_index_then_key": RepairReason.INVALID_CONTAINER_ACCESS,
