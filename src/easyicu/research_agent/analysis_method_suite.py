...
_PHENOTYPING = MethodSuite(
    ...
    methods=(
        ...
        AnalysisMethod(
            ...
            notes="WS3 (#58) implements a DETERMINISTIC runner. It is trajectory-FEATURE clustering — it is deliberately NOT called LCGA. Distinct capability from cross-sectional cluster_solution.",
        ),
        AnalysisMethod(
            key="lcga_gbtm",
