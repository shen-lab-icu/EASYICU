    ...
    *,
    ...
    return revalidate_resume_successes(
        ...
        services=ResumeRevalidationServices(
            ...
            trusted_resume_success_records=_trusted_resume_success_records,
            resume_success_dependencies=_resume_success_dependencies,
            verified_explicit_step_authority=_verified_explicit_step_authority,
            verify_resume_step_script_lineage=_verify_resume_step_script_lineage,
            materialize_verified_step_output_view=(
                _materialize_verified_step_output_view
            ),
            project_verified_replay_output_paths=(
            ...
            discard_stale_resolved_input_receipts=(
