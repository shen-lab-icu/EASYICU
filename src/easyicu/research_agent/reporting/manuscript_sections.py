...
MANUSCRIPT_SECTION_SPECS = (
    ...
    ManuscriptSectionSpec(
        ...
        instruction=(
            ...
            "a `reportable_survival_results` block, do not report an unauthorized "
            "constant hazard ratio. Report its absolute-time estimate and every "
            "interval-specific adjusted estimate with the supplied confidence "
            "intervals, methods, contrasts, and interpretation ceiling; do not "
