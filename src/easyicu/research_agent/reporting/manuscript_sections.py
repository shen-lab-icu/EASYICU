...
MANUSCRIPT_SECTION_SPECS = (
    ...
    ManuscriptSectionSpec(
        ...
        instruction=(
            ...
            "adjusted estimate with the supplied confidence intervals, p-values, "
            "method, adjustment columns, contrast, and interpretation ceiling; "
            "do not infer a new summary across intervals.\n"
