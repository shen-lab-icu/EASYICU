...
def test_validation_finding_is_schema_canonical():
    from easyicu.research_agent.contracts import ValidationFinding as ContractsVF
...
def test_evidence_artifact_is_schema_evidence_record():
    from easyicu.research_agent.contracts import EvidenceArtifact
...
def test_derived_claim_aliases_numeric_claim():
    from easyicu.research_agent.contracts import DerivedClaim, NumericClaim
