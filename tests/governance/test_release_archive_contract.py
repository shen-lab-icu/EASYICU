...
from tests.research_agent.core.test_retired_top_level_imports import (
...
def test_release_archives_preserve_reviewer_contract_and_package_data(
    ...
    try:
        ...
        required_sdist_files = {
            ...
            "src/easyicu/research_agent/robustness/__init__.py",
            "src/easyicu/research_agent/robustness/estimators.py",
            "src/easyicu/research_agent/robustness/panel.py",
            "src/easyicu/research_agent/robustness/primary_effect.py",
            ...
            "src/easyicu/research_agent/providers/prompts/v2/progressive_planner.txt",
            ...
            "tests/governance/test_release_archive_contract.py",
            "tests/governance/test_release_hardening_p0.py",
        ...
        required_canonical_modules = {
            ...
            "easyicu/research_agent/robustness/__init__.py",
            "easyicu/research_agent/robustness/estimators.py",
            "easyicu/research_agent/robustness/panel.py",
            "easyicu/research_agent/robustness/primary_effect.py",
            ...
            "easyicu/research_agent/execution/phase.py",
            ...
            "easyicu/research_agent/providers/prompts/v2/progressive_planner.txt",
...
for name in (
    ...
    'easyicu.research_agent.robustness.estimators',
