...
def test_pi_shell_assets_are_explicitly_wired_before_guided_owner() -> None:
    ...
    assert "js/screens-guided-pi-preview.js?v=20260909-research-displays1" in index
    ...
    assert "js/screens-guided-pi.js?v=20260908-conversation-files1" in index
...
def test_latest_idea_exploration_turn_hides_unrelated_project_continuation_cards() -> None:
    ...
    assert "screens-guided-pi.js?v=20260908-conversation-files1" in index
