...
def test_pi_shell_assets_are_explicitly_wired_before_guided_owner() -> None:
    ...
    assert "css/guided-pi.css?v=20260921-model-menu1" in index
    ...
    assert "js/screens-guided-pi-header.js?v=20260921-model-menu1" in index
    assert "js/screens-guided-pi-model-menu.js?v=20260921-model-menu1" in index
    assert "css/workspace-canvas.css?v=20260921-evidence1" in index
    assert "css/guided-pi-workspace.css?v=20260921-rail-title1" in index
    ...
    assert "js/screens-guided-pi-study-workspace.js?v=20260921-empty-tasks1" in index
    ...
    assert "js/screens-guided-pi-session-view.js?v=20260921-owner-split1" in index
    ...
    assert "js/api.js?v=20260921-model-menu1" in index
...
def test_copilot_plus_menu_keeps_article_url_entry_in_the_conversation() -> None:
    ...
    script = f"""
      ...
      console.log(JSON.stringify({{html, handled, menuRemoved: menu.removed, input}}));
    """
    completed = subprocess.run(
        [node, "--eval", script], check=True, capture_output=True, text=True
    )
