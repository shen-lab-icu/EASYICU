...
def test_pi_shell_assets_are_explicitly_wired_before_guided_owner() -> None:
    ...
    assert "css/guided-pi-workspace.css?v=20260921-fit2" in index
    ...
    assert "js/screens-guided-pi-events.js?v=20260922-popover1" in index
    assert "js/screens-guided-pi-project.js?v=20260901-session-deeplink1" in index
    assert "js/screens-guided-pi-data-consent.js?v=20260922-popover1" in index
    assert "js/screens-guided-pi-data-binding.js?v=20260908-source-conversation1" in index
    assert "js/screens-guided-pi-session-view.js?v=20260922-connectors1" in index
