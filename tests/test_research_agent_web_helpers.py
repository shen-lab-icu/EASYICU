...
def test_workbench_uses_claude_reference_overview_before_detail_inspector() -> None:
    ...
    assert "quiet underline tabs below the Agent header" in css
...
def test_research_agent_shell_header_precedes_view_tabs() -> None:
    ...
    assert 'icon=":material/view_kanban:"' in agent_branch
    assert 'icon=":material/history:"' in agent_branch
    assert 'icon=":material/verified_user:"' in agent_branch
    ...
    assert "margin: 0 0 20px !important" in css
